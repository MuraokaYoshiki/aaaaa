...
#基本統計量
print(f"時給平均 {np.mean(h_wage):.0f}")
print(f"時給標準偏差 {np.std(h_wage):.0f}")
print(f"時給  0% {np.percentile(h_wage,0):.0f}")
print(f"時給 25% {np.percentile(h_wage,25):.0f}")
print(f"時給 50% {np.percentile(h_wage,50):.0f}")
print(f"時給 75% {np.percentile(h_wage,75):.0f}")
print(f"時給100% {np.percentile(h_wage,100):.0f}")
